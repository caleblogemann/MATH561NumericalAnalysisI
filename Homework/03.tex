...
%            \end{align*}
    ...
    \item % 3
        \begin{enumerate}
            ...
            \item[(c)] % TODO: find how to transform result to different interval
                \begin{tabular}{c|c|c|c}
                    $x$ & $f(x)$ & & \\
                    \midrule
                    $c$ & $f(c)$ & & \\
    ...
    \item % 4
        \begin{enumerate}
            ...
            \item[(b)] % TODO: Finish error analysis
                ...
                \[
                    \dintt{0}{\infty}{f(t) e^{-t}}{t} =
                        ...
                        \frac{2 - \sqrt{2}}{4} f(2 + \sqrt{2}) +
                        % TODO: Insert error term
                \]

            \item[(c)] %TODO: use error analysis
